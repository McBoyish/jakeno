			...
			>
				<View style={styles.aboutSection} dataSet={{ media: ids.aboutSection }}>
					...
					<Text style={styles.text}>
						{`I love programming, reading books, tennis and swimming. I come from a small island, Mauritius, located in the Indian Ocean. Through my time in university, I have gained some experience in software development but I would say I still have much more to learn. During my free time, I enjoy reading about game development concepts and writing small games (you can see some of them on my github!).\
						`}
					</Text>
				</View>
