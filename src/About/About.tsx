			...
			>
				<View style={styles.aboutSection} dataSet={{ media: ids.aboutSection }}>
					...
					<Text style={styles.text}>
						{`I love programming, reading books, tennis and swimming. I have working experience in React/React Native, Apollo GraphQL (microservices), ExpressJS. I developed this website with NextJS and ExpressJS with MongoDB as the database. During my free time, I enjoy reading about game development concepts and writing small games (you can see some of them on my github).`}
					</Text>
				</View>
